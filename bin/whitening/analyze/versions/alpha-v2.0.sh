...
ANALYSIS_CONF=configs/whitening/analyzes/fisher_rao_norm.yaml
...
ANALYSIS_CONF=configs/whitening/analyzes/kfac_fisher_rao_norm.yaml
./bin/register.sh $CONTAINER analyses \
    --experiment whitening \
    --config ${ANALYSIS_CONF} \
    --execution-version ${EXECUTION_VERSION} \
...
# Participation ratio
ANALYSIS_CONF=configs/whitening/analyzes/participation_ratio.yaml
./bin/register.sh $CONTAINER analyses \
    --experiment whitening \
    --config ${ANALYSIS_CONF} \
    --execution-version ${EXECUTION_VERSION} \
...
ANALYSIS_CONF=configs/whitening/analyzes/bd_participation_ratio.yaml
./bin/register.sh $CONTAINER analyses \
    --experiment whitening \
    --config ${ANALYSIS_CONF} \
    --execution-version ${EXECUTION_VERSION} \
...
# Spectral norm
ANALYSIS_CONF=configs/whitening/analyzes/spectral_norm.yaml
./bin/register.sh $CONTAINER analyses \
    --experiment whitening \
    --config ${ANALYSIS_CONF} \
    --execution-version ${EXECUTION_VERSION} \
...
# l2 norm
ANALYSIS_CONF=configs/whitening/analyzes/l2.yaml
./bin/register.sh $CONTAINER analyses \
    --experiment whitening \
    --config ${ANALYSIS_CONF} \
    --execution-version ${EXECUTION_VERSION} \
